...
resource "azurerm_network_interface" "privateip" {
  ...
  ip_configuration {
    name                          = var.name
    subnet_id                     = "/subscriptions/eb986b09-9743-4aa1-b10f-53da04d8708c/resourceGroups/my-first-rg/providers/Microsoft.Network/virtualNetworks/main/subnets/default"
